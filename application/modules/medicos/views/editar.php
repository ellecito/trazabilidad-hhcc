  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4" id="div-especialidad">
          <select id="especialidad" name="especialidad[]" multiple data-live-search="true" class="selectpicker especialidad validate[required]">
             <?php if($especialidades){ ?>
             <?php foreach($especialidades as $especialidad){ ?>
                <option value="<?php echo $especialidad->codigo; ?>" <?php if(in_array($especialidad->codigo, $medico_especialidades)) echo "selected"; ?>><?php echo $especialidad->nombre; ?></option>
             <?php } ?>
             <?php } ?>
          </select>
      </div>
