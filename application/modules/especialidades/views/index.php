<div class="page-header">
  <div class="row">
    <h1 class="col-md-7">Especialidades</h1>
    <div class="col-md-3" style="margin-top:24px;">
        <form class="form-inline" method="get" action="<?php echo base_url(); ?>especialidades/">
    ...
    <div class="col-md-2" style=" margin:24px 0 10px;">
      <div class="text-center new">
        <button onclick="javascript:location.href='<?php echo base_url(); ?>especialidades/agregar/'" type="button" class="btn btn-primary col-md-12">Agregar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <tbody class="table-hover">
		<?php if($datos){ ?>
			<?php foreach($datos as $especialidad): ?>
				<tr>
					<td><?php echo $especialidad->codigo; ?></td>
					<td><?php echo $especialidad->nombre;?></td>
					<td class="editar">
            <a class="eliminar" rel="<?php echo $especialidad->codigo; ?>" href="#">
              <button title="Ver" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
						...
						<a href="<?php echo base_url(); ?>especialidades/editar/<?php echo $especialidad->codigo; ?>">
