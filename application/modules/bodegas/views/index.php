<div class="page-header">
  <div class="row">
    <h1 class="col-md-7">Bodegas</h1>
    <div class="col-md-3" style="margin-top:24px;">
        <form class="form-inline" method="get" action="<?php echo base_url(); ?>bodegas/">
    ...
    <div class="col-md-2" style=" margin:24px 0 10px;">
      <div class="text-center new">
        <button onclick="javascript:location.href='<?php echo base_url(); ?>bodegas/agregar/'" type="button" class="btn btn-primary col-md-12">Agregar</button>
      </div>
    </div>
  </div>
</div>
		...
		<?php if($datos){ ?>
            ...
            <a class="eliminar" rel="<?php echo $bodega->codigo; ?>" href="#">
              <button title="Ver" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
						...
						<a href="<?php echo base_url(); ?>bodegas/editar/<?php echo $bodega->codigo; ?>">
